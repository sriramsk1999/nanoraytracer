...
RM = /bin/rm -f
all: nanoraytracer
nanoraytracer: main.o Transform.o Scene.o readfile.o variables.h readfile.h Transform.h
	$(CC) $(CFLAGS) -o nanoraytracer main.o Transform.o Scene.o readfile.o $(INCFLAGS) $(LDFLAGS)
